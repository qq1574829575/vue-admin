  ...
  methods: {
    ...
    addGongwen() {
      ...
      request({
        ...
        method: 'post',
        baseURL: 'http://www.unifiedplatform.guolianrobot.com',
        data: 'param=' + encodeURIComponent(rsaUtil.encryption2(param)) + '&teacherNo=' + this.gongwen.teacherNo + '&fileType=' + this.gongwen.fileType + '&fileTitle=' + this.gongwen.fileTitle + '&fileAddr=' + this.gongwen.fileAddr + '&publicTime=' + this.gongwen.publicTime
      }).then(res => {
        this.loading = false
        if (res.code === 1) {
          this.getGongwenList()
    ...
    editGongwen() {
      ...
      request({
        ...
        method: 'post',
        baseURL: 'http://www.unifiedplatform.guolianrobot.com',
        data: 'param=' + encodeURIComponent(rsaUtil.encryption2(param)) + '&fileType=' + this.gongwen.fileType + '&fileTitle=' + this.gongwen.fileTitle + '&fileAddr=' + this.gongwen.fileAddr + '&publicTime=' + this.gongwen.publicTime
      }).then(res => {
        this.loading = false
        if (res.code === 1) {
          this.getGongwenList()
